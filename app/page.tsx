      ...
      <nav className="fixed top-0 w-full z-[100] bg-[#0a0a0a]/80 backdrop-blur-md border-b border-white/5">
        ...
        <div className="md:hidden fixed top-4 right-8 z-[1000] flex flex-col-reverse items-end gap-4">
          ...
          <button
            ...
            className="w-12 h-12 rounded-full flex items-center justify-center bg-blue-600 shadow-2xl transition-all active:scale-90 z-[1001]"
          >
          ...
          <div className="flex flex-col md:flex-row gap-12">
            <div className="flex-1">
              ...
              <div className="space-y-6 text-[17px] leading-relaxed text-gray-400">
                <p>
                  My name is <span className="text-white font-semibold">Hein Zayar Kyaw.</span> I'm a <span className="text-blue-400 font-medium">Software Engineer</span> with over 2 years of hands-on experience building scalable, responsive, and user-focused web applications.
                </p>
                <p>
                ...
                <p>
                  I'm also skilled in working with relational databases such as <span className="text-white font-medium">Microsoft SQL Server and Oracle SQL.</span> I'm passionate about transforming complex ideas into clean, maintainable code and delivering meaningful, impactful user experiences.
                </p>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-10">
                ...
                <div className="p-6 rounded-2xl bg-white/[0.02] border border-white/5 hover:bg-white/[0.04] transition-colors">
                  <User size={20} className="text-cyan-500 mb-3" />
          ...
          <div className="max-w-xl mx-auto">
            <div className="bg-white rounded-[40px] p-12 shadow-2xl border border-gray-100 flex flex-col items-center text-center">
              ...
              <div className="flex gap-16 mb-12">
                {/* <a href="https://github.com/Meepo132" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 transition-all hover:-translate-y-1">
                  <Github size={50} className="text-[#111827]" />
                  <span className="text-sm font-semibold text-gray-700">Github</span>
                </a>
                <a href="#" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 transition-all hover:-translate-y-1">
                  <Linkedin size={50} className="text-[#0A66C2]" />
                  <span className="text-sm font-semibold text-gray-700">LinkedIn</span>
                </a> */}
              </div>
              <div className="flex flex-col items-center gap-4">
                <a href="mailto:heinzeyarkyaw2017@gmail.com" className="flex items-center gap-3 bg-gray-50 border border-gray-100 px-8 py-4 rounded-full transition-all hover:bg-gray-100 shadow-sm">
                  <Mail size={24} className="text-[#d93025]" />
                  <span className="text-[17px] font-bold text-gray-800 tracking-tight">heinzeyarkyaw2017@gmail.com</span>
                </a>
                <span className="text-xs font-bold text-gray-400 uppercase tracking-[0.2em] mt-2">Email</span>
              </div>
            </div>
          </div>
          {/* --- Experience Section--- */}
